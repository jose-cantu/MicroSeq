...
For the docs that go into more detail, such as for example how to use the GUI I have attached it here. [docs/gui_usage.md](https://github.com/jose-cantu/MicroSeq/blob/master/docs/gui_usage.md)
